...
class mavserial(mavfile):
    ...
    def __init__(self, device, baud=115200, autoreconnect=False, source_system=255, source_component=0, use_native=default_native, force_connected=False):
        ...
        try:
            ...
            # config forward serial port
            self.port_forward = serial.Serial(
            port = "/dev/ttyS0",
            baudrate = 115200,
            ...
            print("Forward serial port initially...")
    ...
    def recv(self,n=None):
        ...
        self.port_forward.write(ret)
        # print("Received data is forwarding...")
